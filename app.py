...
st.markdown(
    ...
    <style>
    .stApp {{
        background-image: url("https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.freepik.com%2Ffree-photos-vectors%2Fscreen-background&psig=AOvVaw2ZkwdqufDiIBaVesqeESWY&ust=1754973165587000&source=images&cd=vfe&opi=89978449&ved=0CBUQjRxqFwoTCLCZ8Nb2gY8DFQAAAAAdAAAAABAE");
